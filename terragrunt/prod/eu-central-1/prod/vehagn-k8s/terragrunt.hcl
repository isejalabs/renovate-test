...
locals {
  ...
  work_disk_size      = include.envcommon.locals.work_disk_size-big
...
inputs = {
  ...
  image = {
    version        = "v1.12.6"
    update_version = "v1.12.11" # renovate: github-releases=siderolabs/talos
  ...
  cluster = {
    ...
    kubernetes_version           = "v1.34.6" # renovate: github-releases=kubernetes/kubernetes
    kubelet                      = <<-EOT
      extraArgs:
    ...
    talos_machine_config_version = "v1.12.11" # renovate: github-releases=siderolabs/talos
    vip                          = "10.7.8.180"
  }
  ...
  volumes = {
    ...
    longhorn = {
      size = include.envcommon.locals.disk_longhorn-big
      type = "disk"
    }
  }
