...
inputs = {
  ...
  image = {
    version        = "v1.12.6"
    update_version = "v1.12.6" # renovate: github-releases=siderolabs/talos
  ...
  cluster = {
    ...
    kubernetes_version           = "v1.34.10" # renovate: github-releases=kubernetes/kubernetes
    kubelet                      = <<-EOT
      extraArgs:
    ...
    talos_machine_config_version = "v1.12.6" # renovate: github-releases=siderolabs/talos
    vip                          = "10.7.8.180"
  }
