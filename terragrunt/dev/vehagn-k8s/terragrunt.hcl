...
terraform {
  ...
  # source = "${include.envcommon.locals.base_source_url}?ref=v5.0.1" # renovate: github-releases=sebiklamar/terraform-modules
...
inputs = {
  ...
  image = {
    version        = "v1.8.4"
    update_version = "v1.12.1" # renovate: github-releases=siderolabs/talos
