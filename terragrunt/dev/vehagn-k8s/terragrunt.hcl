...
terraform {
  ...
  # source = "${include.envcommon.locals.base_source_url}?ref=v6.0.1" # renovate: github-releases=sebiklamar/terraform-modules
  # using hard-coded URL instead of envcommon instead
  source = "git::git@github.com:sebiklamar/terraform-modules.git//modules/vehagn-k8s?ref=vehagn-k8s-v0.3.0"
}
...
inputs = {
  ...
  image = {
    version        = "v1.8.4"
    update_version = "v1.12.2" # renovate: github-releases=siderolabs/talos
